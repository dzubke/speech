...
def main(target_dir, tar_path, sample_rate, min_duration, max_duration):
...
if __name__ == "__main__":
    ...
    main(args.target_dir, args.tar_path, args.sample_rate, args.min_duration, args.max_duration)