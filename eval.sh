...
python eval.py $3 ./examples/librispeech/models/ctc_models/$1/$2 ~/awni_speech/data/speak_test_data/speak_test.json --save ./predictions/$1-$2_speak_test_predictions.json
